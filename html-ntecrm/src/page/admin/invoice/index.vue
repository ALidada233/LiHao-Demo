    ...
    >
      ...
      <el-table-column width="100" label="状态" align="center">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.status==1">开票中</el-tag>
          <el-tag v-if="scope.row.status==2" type="success">已开票</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="billMoney" label="价税合计" align="center"></el-table-column>
