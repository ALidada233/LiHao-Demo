  ...
  <div>
    <div class="clearPa section">
      ...
      <div class="left home">
        <!--今日概况 -->
        <h1
          style="padding: 10px;background:#fff;border-top-left-radius: 10px;border-top-right-radius: 10px;"
        >
        ...
        >
          ...
          <div class="left home-today-child" style="cursor:pointer">
            <div class="home-today-center clearPa">
              <div class="left" style="margin:0px 12px 0 10%;">
                <i class="iconfont" style="font-size: 22px;background:#FBCA20;">&#xe63e;</i>
              </div>
              <div class="left">
                <span style="color:#FBCA20;font-size:18px;">{{summaryList.demandRates}}</span>
                <p>需求转换率</p>
              </div>
            </div>
          </div>
          ...
          <div class="left home-today-child" style="cursor:pointer">
            <div class="home-today-center clearPa">
              <div class="left" style="margin:0px 12px 0 10%;">
                <i class="iconfont" style="font-size: 22px;background:#f33b4a;">&#xe6f7;</i>
              </div>
              <div class="left">
                <span style="color:#f33b4a;font-size:18px;">{{summaryList.orderRates}}</span>
                <p>订单转换率</p>
              </div>
            </div>
          </div>
        ...
        <div style="margin:10px 0;float: left;width: 100%;background:#fff;margin-bottom: 0;">
          ...
          <div class="reportTable" style="padding:10px;box-size:border-box;padding-top:0;">
            <el-table
              v-loading="loading"
              :data="dataList"
              :height="reportTabelHeight?500:100"
              :border="true"
              style="width: 100%;margin-top: 10px;"
            >
              <el-table-column label="操作人" align="center" prop="createName" width="100"></el-table-column>
                  ...
                  <span>
                    ...
                    >
                      <span
                        ...
                        v-html="$root.OmissionText(scope.row.companyName,10)"
                      ></span>
                    </el-popover>
                  </span>
                </template>
              </el-table-column>
              <el-table-column label="终端" align="center" prop="remark" width="120"></el-table-column>
              ...
              <el-table-column label="产品信息" align="center" prop="goods_info">
                <template slot-scope="scope">
                  <div>
                    <el-popover
                      placement="top-start"
                      ...
                      width="350"
                      trigger="hover"
                      :content="scope.row.goodsInfo+(scope.row.partsInfo?'-辅件：'+scope.row.partsInfo:'')||''"
                    >
                      <span
                        slot="reference"
                        style="cursor:default;"
                        v-html="$root.OmissionText(scope.row.goodsInfo+(scope.row.assistInfo||''),75)"
                      ></span>

                      <div
                        slot="reference"
                        style="cursor:default;"
                        v-if="scope.row.partsInfo"
                        v-html="$root.OmissionText(scope.row.partsInfo,75)"
                      ></div>
                    </el-popover>
                  </div>
                </template>
              ...
              <el-table-column label="报备有效期" align="center" width="180" prop="reportTime"></el-table-column>
            </el-table>
            <div style="text-align:center;font-size:22px;">
              <i
                class="iconfont"
                style="color:#409EFF;cursor:pointer;"
                @click="reportTabelHeight=!reportTabelHeight"
                v-if="reportTabelHeight"
              >&#xe661;</i>
              <i
                class="iconfont"
                style="color:#409EFF;cursor:pointer;"
        ...
        <div class="left home-today-three">
          ...
          <div style="height:400px;background:#fff;">
            <component
              :is="chartArt"
              :id="highchartOptions[4].id"
              :option="highchartOptions[4].option"
          ...
          <div style="height:400px;background:#fff;">
            <component
              :is="chartArt"
              :id="highchartOptions[5].id"
              :option="highchartOptions[5].option"
              style="margin-top:15px;height:400px;"
            ></component>
          </div>
          <div style="height:400px;background:#fff;">
            <component
              :is="chartArt"
              :id="highchartOptions[6].id"
              :option="highchartOptions[6].option"
              style="margin-top:15px;height:400px;"
            ></component>
          </div>
        </div>
        ...
        <div class="left home-today-three">
          ...
          <div style="height:400px;background:#fff;">
            <component
              :is="chartArt"
              :id="highchartOptions[0].id"
              :option="highchartOptions[0].option"
              style="margin-top:15px;height:400px;"
            ></component>
          </div>
        </div>
        <div class="left home-today-three" style>
          ...
          <div style="height:400px;background:#fff;">
            <component
              :is="chartArtCurtomer"
              :id="highchartOptions[1].id"
              :option="highchartOptions[1].option"
              style="margin-top:15px;height:400px;border-radius: 10px;"
            ></component>
          </div>
        </div>
        <div class="left home-today-one" style>
          ...
          <component
            :is="chartArt"
            :id="highchartOptions[2].id"
            :option="highchartOptions[2].option"
            style="margin-top:15px;height:400px;border-radius: 10px;"
          ></component>
        </div>
        <div class="left home-today-two" style>
          ...
          <component
            :is="chartArt"
            :id="highchartOptions[3].id"
            :option="highchartOptions[3].option"
            style="margin-top:15px;height:400px;border-radius: 10px;"
          ></component>
        </div>
      </div>
...
import { getSummary, getAreaCount, getReport } from "@/util/req/home/index.js";
