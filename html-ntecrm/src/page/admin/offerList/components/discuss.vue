          ...
          <p class="rpiHandle">
            ...
            <span v-if="item.children.length>0">
              <i
                ...
                @click="item.foldStatus=!item.foldStatus;statusChange(item.foldStatus,null,item);"
      ...
      <div style="height:400px;overflow-y:scroll;">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item label="回复内容">
            <el-input type="textarea" style="width:400px;" rows="4" v-model="form.remark"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <span slot="footer" class="dialog-footer">
    ...
    >
      <div style="height:500px;overflow-y:scroll;">
        <el-form ref="formAdd" :model="formAdd" label-width="120px">
          ...
          <el-form-item label="回复内容">
            <el-input type="textarea" style="width:400px;" rows="4" v-model="formAdd.remark"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <span slot="footer" class="dialog-footer">
...
import { getBuyerTechnical } from "util/req/offerList/index";
export default {
  name: "discuss",
  props: {
    type: {
    ...
    getTechnicalSupportByDto() {
      ...
      getTechnicalSupportByDto(parmas, res => {
        ...
        if (
          newItem[0] &&
          newItem[0].readName &&
          newItem[0].readName.indexOf("未读") > -1
        ) {
