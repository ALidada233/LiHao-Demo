        ...
        <div class="htmlModel" id="subOutputRank-print" ref="print" style="background: #fff;">
          <div class="clear" style="padding-top:50px;">
            ...
            <div style="float:left;width:40%;line-height:25px;">
              ...
              >
                TEL:0755-23320851 &nbsp;
                FAX:0755-23320851-8018
              </p>
              <p style="font-size: 17px;line-height: 28px;" v-if="content.custBelong==2">
                TEL:0755-82908211 &nbsp;
                FAX:0755-82959939-802
              </p>
              <p
                style="font-size: 17px;line-height: 28px;"
                v-if="content.custBelong==1||content.custBelong==3"
          ...
          <div style="margin-top:35px;" class="clear">
            <div
              style="float:left;width:60%;font-size:18px;line-height:33px;padding:10px 20px;box-sizing: border-box;color: #999;margin-top: 30px;"
            >
            ...
            <div
              style="float:right;width:40%;font-size:18px;line-height:33px;position:relative;top:-37px;"
            >
              <p
                style="color:#333;font-weight:500;color: #FF0000;font-size:35px;margin-bottom:10px;"
              >QUOTATION 报价单</p>
              <p style="color:#333;font-weight:500;">
                <span>NO.报价单编号：</span>
                {{content.offerCode}}
          ...
          <div style="margin-top:25px;border:1px solid #000;" class="clear">
            ...
            <p style="padding:15px 5px;border-bottom:1px solid #000;font-size: 17px;">
              是否附带技术协议：否□
              是□（技术协议编号：&nbsp;&nbsp;&nbsp;&nbsp;）
            </p>
            <p
          ...
          <div style="margin-top:25px;font-size:17px;line-height:30px;" class="clear">
            ...
            <p>E.EFFECTIVE TIME 有效日期：有效时间45天；</p>
          </div>
          <p
            v-if="content.custBelong==1||content.custBelong==3"
