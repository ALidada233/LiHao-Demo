<template>
  <div>
    ...
    <el-drawer :visible.sync="drawer" class="myDrawer" :show-close="false" size="60%">
      <template>
        <div class="message">
          <div style="padding:20px;">
            <div>
              <template>
                ...
                <el-tabs v-model="type" type="card" @tab-click="changeMsgType" style="width:100%;">
                  <el-tab-pane label="全部" name="all"></el-tab-pane>
                  <el-tab-pane label="客户新增" name="1"></el-tab-pane>
                  <el-tab-pane label="联系人新增" name="2"></el-tab-pane>
                  <el-tab-pane label="折扣申请" name="3"></el-tab-pane>
                  <el-tab-pane label="折扣审批" name="4"></el-tab-pane>
                  <el-tab-pane label="产品资料" name="5"></el-tab-pane>
                  <el-tab-pane label="订单申请" name="6"></el-tab-pane>
                  <el-tab-pane label="订单确认" name="7"></el-tab-pane>
                  <el-tab-pane label="采购订单" name="8"></el-tab-pane>
                  <el-tab-pane label="货期确认" name="9"></el-tab-pane>
                  <el-tab-pane label="售前服务" name="10"></el-tab-pane>
                  <el-tab-pane label="发票申请" name="11"></el-tab-pane>
                  <el-tab-pane label="发票审批" name="12"></el-tab-pane>
                  <el-tab-pane label="调试服务" name="13"></el-tab-pane>
                  <el-tab-pane label="售后服务" name="14"></el-tab-pane>
                  <el-tab-pane label="项目报备" name="15"></el-tab-pane>
                </el-tabs>
                <!-- <el-select
                  v-model="type"
                  clearable
                ...
                >
                  ...
                  <el-option label="售前服务" :value="10"></el-option>
                  <el-option label="发票申请" :value="11"></el-option>
                  <el-option label="发票审批" :value="12"></el-option>
                  <el-option label="调试服务" :value="13"></el-option>
                  <el-option label="售后服务" :value="14"></el-option>
                  <el-option label="项目报备" :value="15"></el-option>
                </el-select>-->
              </template>
            </div>
            <el-timeline
              ...
              >
                <el-card>
                  <h4>
                    ...
                    <el-tag type="info" v-if="item.type==10">售前服务</el-tag>
                    <el-tag type="info" v-if="item.type==11">发票申请</el-tag>
                    <el-tag type="info" v-if="item.type==12">发票审批</el-tag>
                    <el-tag type="info" v-if="item.type==13">调试服务</el-tag>
                    <el-tag type="info" v-if="item.type==14">售后服务</el-tag>
                    <el-tag type="info" v-if="item.type==15">项目报备</el-tag>
                  </h4>
                  <p
            ...
            <div class="block" style="margin-top:10px;background:#eee;padding: 10px;">
              <el-switch
                style="float:left;"
                v-model="status"
                active-color="#13ce66"
