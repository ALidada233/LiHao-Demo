<template>
  <div class="orderDeduction">
    ...
    >
      ...
      <el-table-column width="100" prop="brandName" label="品牌" align="center"></el-table-column>
      <el-table-column width="100" label="状态" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.status==1">创建</el-tag>
          <el-tag type="info" v-if="scope.row.status==2">申请商务费</el-tag>
...
<script>
import { saveOrderCommission } from "util/req/order/index";
