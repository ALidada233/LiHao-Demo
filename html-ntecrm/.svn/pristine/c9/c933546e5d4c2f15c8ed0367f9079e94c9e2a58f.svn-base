  ...
  <div class="message">
    <div style="padding:20px;">
      ...
      <el-table
        ...
        class="msgTable"
      >
        <el-table-column label="操作" fixed align="center" width="130">
          <template slot-scope="scoped">
            <el-button
              ...
              round
              size="mini"
              @click="refuseHandle(scoped.row,1)"
              icon="el-icon-check"
            ></el-button>
            <el-button
              type="danger"
              ...
              round
              size="mini"
              @click="refuseHandle(scoped.row,2)"
              icon="el-icon-close"
            ></el-button>
          </template>
        </el-table-column>
        <el-table-column prop="goodsName" label="商品名称" align="center" width="250">
        ...
        <el-table-column label="原折扣率" align="center" width="80">
          <template slot-scope="scope">
            <span>{{scope.row.orgDiscount || 0.00}}%</span>
          </template>
        </el-table-column>
        <el-table-column label="申请折扣" align="center" width="80">
          <template slot-scope="scope">
            ...
            <span>
              ...
              >
                <span
                  slot="reference"
                  style="cursor:default;"
                  v-html="$root.OmissionText(scope.row.reason==null?null:scope.row.reason,12)"
                ></span>
              </el-popover>
            </span>
          </template>
        </el-table-column>
        <el-table-column prop="createName" label="申请人" align="center" width="80"></el-table-column>
        <el-table-column prop="createTime" label="申请日期" align="center" width="160"></el-table-column>
        <el-table-column prop="updateName" label="审核人" align="center" width="80"></el-table-column>
        <el-table-column prop="updateTime" label="审核日期" align="center" width="160"></el-table-column>
        <el-table-column label="审核备注" align="center" width="200">
          <template slot-scope="scope">
            <span>
              <el-popover
                placement="top-start"
...
import {
  queryDiscountList,
  saveDiscountApply
} from "util/req/discountApp/index";
export default {
  name: "discountApp",
  data() {
    return {
