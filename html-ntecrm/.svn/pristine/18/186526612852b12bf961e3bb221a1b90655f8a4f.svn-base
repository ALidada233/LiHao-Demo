  ...
  <div class="customersContract">
    <div style="padding:20px;">
      ...
      <div class="left" style="margin-bottom: 20px;">
        ...
        <el-button
          type="primary"
          size="medium"
          @click="$emit('closeContractDialog');clearItem()"
          icon="el-icon-back"
        ></el-button>
      </div>
      <el-table
        ...
        <el-table-column label="操作" width="65">
          <template slot-scope="props">
            <el-button
              ...
              @click="comfirmContract(props.row)"
            ></el-button>
          </template>
        </el-table-column>
        <el-table-column label="报价单号" align="center" width="150" prop="offerCode"></el-table-column>
    ...
    <transition name="fade-transform">
      <component
        ...
        class="naiteen"
        @closeContractDialog="naiteenVisible=false;naiteenId=null;clearItem();$root.BackToTop();"
...
export default {
  ...
  methods: {
    ...
    comfirmContract(row) {
      ...
      if (this.type == "offer" && row.custBelong == 2) {
        this.selectType = "offer";
      } else if (
        this.type == "offer" &&
        (row.custBelong == 1 || row.custBelong == 3)
      ) {
        this.selectType = "biyouOffer";
      } else {
        this.selectType = "contract";
      }
  ...
  components: {
    offer: () => import("@/page/admin/offerList/components/template"),
    biyouOffer: () => import("@/page/admin/offerList/components/biyouTemplate"),
    contract: () =>
      import("@/page/admin/offerList/components/components/template")
  }
};
</script>
